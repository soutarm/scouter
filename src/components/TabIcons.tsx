...
export const EnvironmentIcon  = () => <svg {...svgProps}><circle cx="12" cy="7.5" r="2.5"/><circle cx="8" cy="10" r="2.5"/><circle cx="16" cy="10" r="2.5"/><circle cx="9.5" cy="14" r="2.5"/><circle cx="14.5" cy="14" r="2.5"/><circle cx="12" cy="11" r="1.3" fill="currentColor" stroke="none"/><path d="M12 17v5"/></svg>
