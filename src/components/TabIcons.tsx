...
export const EnvironmentIcon  = () => <svg {...svgProps}><polygon points="12,3 20,15 4,15" fill="currentColor" stroke="none"/><rect x="10" y="15" width="4" height="6" rx="1" fill="currentColor" stroke="none"/></svg>
